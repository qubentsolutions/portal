export const featureItems = [
  {
    ...
    title: "Unique Design",
    description:
      "Crafted with creativity, every pixel tells a story. Designs that stand out and leave a mark.",
  },
  {
    id: 2,
    className: "col-md-4 col-lg-3 d-flex align-items-stretch mb-sm-30",
    ...
    title: "Quality Code",
    description:
      "No shortcuts, just solid foundations. Delivering excellence through every line of code.",
  },
  {
    id: 3,
    ...
    description:
      "Less noise, more value. A refined approach to digital presence. Every detail matters.",
  },
];
...
export const featureItems2 = [
  {
    ...
    className: "col-lg-6",
    path: "M21.62 20.196c1.055-.922 1.737-2.262 1.737-3.772 0-1.321-.521-2.515-1.357-3.412v-6.946l-11.001-6.066-11 6v12.131l11 5.869 5.468-2.917c.578.231 1.205.367 1.865.367.903 0 1.739-.258 2.471-.676l2.394 3.226.803-.596-2.38-3.208zm-11.121 2.404l-9.5-5.069v-10.447l9.5 4.946v10.57zm1-.001v-10.567l5.067-2.608.029.015.021-.04 4.384-2.256v5.039c-.774-.488-1.686-.782-2.668-.782-2.773 0-5.024 2.252-5.024 5.024 0 1.686.838 3.171 2.113 4.083l-3.922 2.092zm6.833-2.149c-2.219 0-4.024-1.808-4.024-4.026s1.805-4.025 4.024-4.025c2.22 0 4.025 1.807 4.025 4.025 0 2.218-1.805 4.026-4.025 4.026zm-.364-3.333l-1.306-1.147-.66.751 2.029 1.782 2.966-3.12-.725-.689-2.304 2.423zm-16.371-10.85l4.349-2.372 9.534 4.964-4.479 2.305-9.404-4.897zm9.4-5.127l9.404 5.186-3.832 1.972-9.565-4.98 3.993-2.178z",
    title: "Domain-Driven Excellence",
    description:
      "We bring tailored strategies across industries like fintech, healthcare, e-commerce, education, and logistics.",
  },
  {
    id: 2,
    className: "col-lg-6",
    ...
    description:
      "We use modern, proven technologies—from Node.js and React to Flutter and Kubernetes—for performance and scalability.",
  },
  {
    id: 3,
    className: "col-lg-6",
    ...
    description:
      "We follow industry best practices to ensure your software is secure, stable, and meets the highest standards.",
  },
  {
    id: 4,
    className: "col-lg-6",
    ...
    description:
      "We place your goals at the center of everything we do—offering tailored solutions through active collaboration, transparency, and continuous alignment.",
  },
];
