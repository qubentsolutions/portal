              ...
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-descr">
                    We believe the best solutions are often the simplest. Our work is intuitive, clutter-free, and easy to use—ensuring a seamless experience for both users and stakeholders.
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-descr">
                    Transparency and responsibility are at our core. We stay accountable at every step—communicating clearly, meeting deadlines, and delivering exactly what we promise.
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-title">Consultancy</div>
                  <div className="features-descr">
                    We go beyond execution to offer expert guidance. From strategy to implementation, our consultancy ensures you make informed decisions that drive real business value.
                  </div>
                </div>
              </SwiperSlide>
              {/* <SwiperSlide className="owl-item">
